...
import {
  ...
  Edit, Award, Gift, Briefcase, BarChart3, Plus, ArrowLeft, X,
...
const ReferralLinks = () => {
  ...
  // Handle copy referral URL to clipboard (copy the actual link.url being displayed)
      ...
      <CardContent className="pb-3">
        ...
        <div className="flex items-center space-x-2 bg-muted p-2 rounded-md">
          ...
          <Button
            ...
            className="h-7 px-2"
          >
            {isCopied ? <Check className="h-4 w-4" /> : <Copy className="h-4 w
