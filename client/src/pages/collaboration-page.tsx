          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-semibold text-gray-900">Collaboration Matchmaker</h1>
                  <p className="text-sm text-gray-600">Discover potential collaborators based on your skills, projects, and industry. Connect with like-minded professionals and start working together.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-700">Skills or Keywords</label>
                    <Input
                  ...
                  {userSkills.length === 0 ? (
                    ...
                    <div className="space-y-2">
                      {userSkills.map((skill) => (
                        <div key={skill.name} className="flex items-center justify-between bg-gray-50 rounded-md px-3 py-2">
